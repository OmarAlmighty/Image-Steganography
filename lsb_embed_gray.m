function [ stego,len ] = lsb_embed_gray( c,s_dec,k,iv )
%%
stego = c;
...
for r=1:rows
    for c=1:cols
        ...
        green = stego(r,c,2);
        blue = stego(r,c,3);
        %% hide k/3 bit in each channel instead of hiding k bit in each channel, k must be multiple of 3
        red = dec2bin(red,8);
